...
description: "Index of 6 pages and 0 subdirectories under langgraph/errors."
category: "index"
tags: [index, langgraph, errors]
---
...
- [INVALID_CHAT_HISTORY](INVALID_CHAT_HISTORY.md) - This error is raised in the prebuilt create_agent when the call_model graph node receives a malformed list of messages. Specifically, it is malformed when there are AIMessages with tool_calls (LLM...
