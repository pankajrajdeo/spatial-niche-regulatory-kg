---
title: "langgraph"
description: "Index of 37 pages and 2 subdirectories under langgraph."
category: "index"
tags: [index, langgraph]
---

# langgraph

37 pages here, 46 pages including subdirectories.
...
- [INVALID_GRAPH_NODE_RETURN_VALUE](INVALID_GRAPH_NODE_RETURN_VALUE.md) - A LangGraph StateGraph received a non-dict return type from a node. Here's an example:
...
- [Persistence](durable-execution.md) - LangGraph's persistence layer gives agents short-term memory through checkpointers and long-term memory through stores.
...
- [LangGraph overview](index.md) - Gain control with LangGraph to design agents that reliably handle complex tasks
