---
title: "Get Platform Oauth Provider"
description: "Get a platform-level OAuth provider available to all workspaces."
source: "https://docs.langchain.com/api-reference/auth-service-v2/get-platform-oauth-provider"
category: "docs"
tags: [docs, api-reference, auth-service-v2, get-platform-oauth-provider]
---
...
security: []
paths:
  /v2/auth/platform-providers/{provider_id}:
    get:
      tags:
        - Auth Service (v2)
      summary: Get Platform Oauth Provider
      description: Get a platform-level OAuth provider available to all workspaces.
      operationId: get_platform_oauth_provider_v2_auth_platform_providers__provider_id__get
      parameters:
        - name: provider_id
          in: path
          required: true
