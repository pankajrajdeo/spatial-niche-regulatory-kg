...
source: "https://docs.langchain.com/api-reference/deployments-v2"
category: "docs"
tags: [docs, api-reference, deployments-v2]
---
        ...
        - name: name
          ...
          schema:
            anyOf:
              - type: string
              - type: 'null'
            description: Exact deployment name to filter by.
            title: Name
          description: Exact deployment name to filter by.
        - name: status
          in: query
        ...
        - name: url
          ...
          schema:
            anyOf:
              - type: string
              - type: 'null'
            description: Serving URL of the deployment to filter by.
            title: Url
          description: Serving URL of the deployment to filter by.
        - name: agent_id
          in: query
          ...
          schema:
            anyOf:
              - type: string
                ...
                maxLength: 255
              - type: 'null'
            description: Exact agent ID (slug) to filter by. Requires agent mode.
            title: Agent Id
          description: Exact agent ID (slug) to filter by. Requires agent mode.
          ...
          schema:
            anyOf:
              - enum:
                ...
                type: string
              - type: 'null'
            description: Agent environment to filter by. Requires agent mode.
