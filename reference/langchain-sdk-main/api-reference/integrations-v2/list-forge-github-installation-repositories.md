---
title: "List Forge Github Installation Repositories"
description: "List repositories available through a Forge GitHub App installation."
source: "https://docs.langchain.com/api-reference/integrations-v2/list-forge-github-installation-repositories"
category: "docs"
tags: [docs, api-reference, integrations-v2, list-forge-github-installation-repositories]
---

# List Forge Github Installation Repositories

> List repositories available through a Forge GitHub App installation.

## OpenAPI

**https://api.host.langchain.com/openapi.json get /v2/integrations/forge-github/installations/{integration_id}/repositories**
...
security: []
paths:
  /v2/integrations/forge-github/installations/{integration_id}/repositories:
    get:
      tags:
        - Integrations (v2)
      summary: List Forge Github Installation Repositories
      description: List repositories available through a Forge GitHub App installation.
      operationId: >-
        list_forge_github_installation_repositories_v2_integrations_forge_github_installations__integration_id__repositories_get
      parameters:
        - name: integration_id
          in: path
          required: true
