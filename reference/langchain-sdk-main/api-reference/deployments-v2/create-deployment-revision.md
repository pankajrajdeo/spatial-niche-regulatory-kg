...
description: "Create a new revision for a deployment."
source: "https://docs.langchain.com/api-reference/deployments-v2/create-deployment-revision"
category: "docs"
tags: [docs, api-reference, deployments-v2, create-deployment-revision]
---
...
paths:
  /v2/deployments/{deployment_id}/revisions:
    post:
      tags:
        - Deployments (v2)
      summary: Create Deployment Revision
      description: |-
        Create a new revision for a deployment.

        The dedicated create-revision entry point: unlike PATCH, this always
        creates a revision and returns the created ``Revision`` directly.
      operationId: create_deployment_revision_v2_deployments__deployment_id__revisions_post
      parameters:
        - name: deployment_id
          in: path
          required: true
    ...
    RevisionCreateRequest:
      properties:
        revision_source:
          ...
          description: >-
            Override the source for this revision. If omitted, falls back to the
        ...
        shareable:
          ...
          description: >-
            ...
            the organization after creating this revision. If omitted, the
            current sharing setting is preserved.
      ...
      type: object
      title: RevisionCreateRequest
      description: |-
        Request body for creating a new revision of an existing deployment.

        The revision-relevant subset of ``DeploymentPatchRequest``.
    Revision:
      properties:
        id:
          type: string
        ...
        status_message:
          ...
          description: >-
            Human-readable detail about the current status, such as why a build
            or deploy failed.<br><br>This is a read-only field.
        source:
          type: string
          enum:
            - github
