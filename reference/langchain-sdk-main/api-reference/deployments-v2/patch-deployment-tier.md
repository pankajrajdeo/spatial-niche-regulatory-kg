...
description: "Patch a deployment's fixed resource tier."
source: "https://docs.langchain.com/api-reference/deployments-v2/patch-deployment-tier"
category: "docs"
tags: [docs, api-reference, deployments-v2, patch-deployment-tier]
---
...
security: []
paths:
  /v2/deployments/{deployment_id}/deployment-tier:
    patch:
      tags:
        - Deployments (v2)
      summary: Patch Deployment Tier
      description: Patch a deployment's fixed resource tier.
      operationId: >-
        patch_deployment_tier_v2_deployments__deployment_id__deployment_tier_patch
      parameters:
        - name: deployment_id
          in: path
          required: true
      ...
      requestBody:
        ...
        content:
          application/json:
            schema:
              $ref: '#/components/schemas/DeploymentTierUpdateRequest'
      responses:
        '200':
...
components:
  schemas:
    DeploymentTierUpdateRequest:
      ...
      required:
        - deployment_tier
      title: DeploymentTierUpdateRequest
      description: Request body for updating a deployment's fixed resource tier.
    Deployment:
      properties:
        name:
          anyOf:
