...
description: "List deploy logs for a deployment (across all revisions)."
source: "https://docs.langchain.com/api-reference/deployments-v2/list-deployment-logs"
category: "docs"
tags: [docs, api-reference, deployments-v2, list-deployment-logs]
---
...
security: []
paths:
  /v2/deployments/{deployment_id}/logs:
    get:
      tags:
        - Deployments (v2)
      summary: List Deployment Logs
      description: List deploy logs for a deployment (across all revisions).
      operationId: list_deployment_logs_v2_deployments__deployment_id__logs_get
      parameters:
        - name: deployment_id
          in: path
          required: true
