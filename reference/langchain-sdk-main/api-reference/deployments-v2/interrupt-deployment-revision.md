---
title: "Interrupt Deployment Revision"
description: "Interrupt an in-progress revision build/deploy."
source: "https://docs.langchain.com/api-reference/deployments-v2/interrupt-deployment-revision"
category: "docs"
tags: [docs, api-reference, deployments-v2, interrupt-deployment-revision]
---
...
security: []
paths:
  /v2/deployments/{deployment_id}/revisions/{revision_id}/interruption:
    post:
      tags:
        - Deployments (v2)
      summary: Interrupt Deployment Revision
      description: Interrupt an in-progress revision build/deploy.
      operationId: >-
        interrupt_deployment_revision_v2_deployments__deployment_id__revisions__revision_id__interruption_post
      parameters:
        - name: deployment_id
          in: path
          required: true
