...
category: "docs"
tags: [docs, javascript, deepagents, context-engineering]
---
...
Define the shape of that data with `contextSchema`, typically a Zod object schema (for example `z.object({ ... })`). Pass runtime values in the **`context`** field of the options object you pass to `invoke` / `ainvoke`. See [Runtime](../langchain/runtime.md) and [LangGraph runtime context](../langgraph/graph-api.md#runtime-context) for full detail.
...
#### [View example trace](https://smith.langchain.com/public/3f16f08a-46ef-4b67-9dab-5d2478341843/r)
...
#### [View example trace](https://smith.langchain.com/public/5b8bfe15-a23f-4b74-b406-3e4e6f0ab709/r)
Open a public LangSmith run for this example.
