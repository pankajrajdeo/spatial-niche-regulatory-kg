...
category: "docs"
tags: [docs, javascript, deepagents, frontend, sandbox]
---
...
> **Interactive example:** [Open it in the original LangChain documentation](https://docs.langchain.com/oss/javascript/deepagents/frontend/sandbox).
...
Wire the agent as an async [graph factory](../../../langsmith/graph-rebuild.md) that reads
