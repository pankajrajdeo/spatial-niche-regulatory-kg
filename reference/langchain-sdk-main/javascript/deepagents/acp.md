...
category: "docs"
tags: [docs, javascript, deepagents, acp]
---
...
#### [Deep Agents ACP on npm](https://www.npmjs.com/package/deepagents-acp)
...
| `middleware`   | `AgentMiddleware[]`                            | Custom middleware appended to the [Deep Agents stack](customization.md#deep-agents-stack) |
