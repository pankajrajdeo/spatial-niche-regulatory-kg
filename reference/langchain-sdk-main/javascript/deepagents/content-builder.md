...
source: "https://docs.langchain.com/oss/javascript/deepagents/content-builder"
category: "docs"
tags: [docs, javascript, deepagents, content-builder]
---
...
This guide demonstrates how to build a content writing agent from scratch using [Deep Agents](../deepagents.md).
