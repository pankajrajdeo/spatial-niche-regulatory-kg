...
category: "docs"
tags: [docs, javascript, deepagents, quickstart]
---
...
* Python: [https://docs.langchain.com/oss/python/deepagents/quickstart.md](../../deepagents/quickstart.md)
* TypeScript: [https://docs.langchain.com/oss/javascript/deepagents/quickstart.md](quickstart.md)
...
* **Deploy to production**: Use [Managed Deep Agents](../../langsmith/javascript/managed-deep-agents-overview.md) to create, run, and operate deep agents in LangSmith.
