...
source: "https://docs.langchain.com/oss/javascript/deepagents/ag-ui"
category: "docs"
tags: [docs, javascript, deepagents, ag-ui]
---
...
> * [Agent Client Protocol (ACP)](acp.md) connects a deep agent to code editors and IDEs.
> * [Model Context Protocol (MCP)](../langchain/mcp.md) lets a deep agent call tools hosted by external servers.
> * [Agent2Agent (A2A)](a2a.md) connects a deep agent to other agents.
...
#### [AG-UI LangGraph adapter on npm](https://www.npmjs.com/package/@ag-ui/langgraph)
...
For the interrupt model itself, see [Human-in-the-loop](human-in-the-loop.md).
...
#### [AG-UI clients](https://docs.ag-ui.com/integrations)
The full list of AG-UI clients and SDKs, including terminal and mobile clients.

#### [Build a custom client](https://docs.ag-ui.com/quickstart/clients)
...
* [CopilotKit](../langchain/frontend/integrations/copilotkit.md): Python and TypeScript CopilotKit runtime patterns for Deep Agents over AG-UI
* [Frontend overview](frontend/overview.md): Build UIs that stream deep agent progress with the LangChain frontend SDKs
* [Human-in-the-loop](human-in-the-loop.md): Interrupt and resume model for deep agents
* [Agent Client Protocol (ACP)](acp.md): Connect deep agents to code editors and IDEs
