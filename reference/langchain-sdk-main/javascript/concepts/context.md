...
category: "docs"
tags: [docs, javascript, concepts, context]
---
...
State can also be accessed by the agent's **tools**, which can read or update the state as needed. See [tool calling guide](../langchain/tools.md#access-context) for details.
