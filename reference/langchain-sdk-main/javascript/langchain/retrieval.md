---
title: "Retrieval"
description: "Large Language Models (LLMs) are powerful, but they have two key limitations:"
source: "https://docs.langchain.com/oss/javascript/langchain/retrieval"
category: "docs"
tags: [docs, javascript, langchain, retrieval]
---
...
#### [Tutorial: Semantic search](knowledge-base.md)
...
**Extended example: Agentic RAG for LangGraph**
...
#### [Tutorial: RAG with Deep Agents](../deepagents/rag.md)
