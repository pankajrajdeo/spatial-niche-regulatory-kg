---
title: "javascript/langchain"
description: "Index of 31 pages and 5 subdirectories under javascript/langchain."
category: "index"
tags: [index, javascript, langchain]
---

# javascript/langchain

31 pages here, 73 pages including subdirectories.
...
- [multi-agent/](multi-agent/_index.md) - 9 pages
...
- [Runtime](runtime.md) - LangChain's createAgent runs on LangGraph's runtime under the hood.
...
- [Structured output](structured-output.md) - Structured output allows agents to return data in a specific, predictable format. Instead of parsing natural language responses, you get typed structured data.
