...
source: "https://docs.langchain.com/oss/javascript/langchain/errors/INVALID_PROMPT_INPUT"
category: "docs"
tags: [docs, javascript, langchain, errors, invalid_prompt_input]
---
...
3. Debug by examining actual inputs to your prompt template by using [LangSmith](../../../langsmith/observability.md) or logging to verify they match expectations
