...
category: "docs"
tags: [docs, javascript, langchain, multi-agent, custom-workflow]
---
...
> [!NOTE]
> In production, use a persistent vector store such as [Weaviate](../../integrations/vectorstores/weaviate.md), [Pinecone](../../integrations/vectorstores/pinecone.md), or [MongoDB Atlas](../../integrations/vectorstores/mongodb_atlas.md) instead of `MemoryVectorStore`. See [all vector stores](../../integrations/vectorstores.md).
