...
category: "docs"
tags: [docs, javascript, langchain, context-engineering]
---
...
> * Use life-cycle hooks like `beforeModel`, `afterModel`, or `wrapToolCall` (for tool returns) to update the conversation history. See the [middleware documentation](middleware.md) for more details.
>
