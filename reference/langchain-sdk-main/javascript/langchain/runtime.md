---
title: "Runtime"
description: "LangChain's createAgent runs on LangGraph's runtime under the hood."
source: "https://docs.langchain.com/oss/javascript/langchain/runtime"
category: "docs"
tags: [docs, javascript, langchain, runtime]
---
...
2. **Store**: a [BaseStore](https://reference.langchain.com/javascript/langchain-core/stores/BaseStore) instance used for [long-term memory](long-term-memory.md)
