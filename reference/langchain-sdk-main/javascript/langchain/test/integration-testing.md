...
category: "docs"
tags: [docs, javascript, langchain, test, integration-testing]
---
...
`toHaveBeenInterrupted()` checks for a `__interrupt__` field in a [LangGraph interrupt](../human-in-the-loop.md) result. Pass a value to match the interrupt payload:
