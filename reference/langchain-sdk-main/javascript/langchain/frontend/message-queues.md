...
category: "docs"
tags: [docs, javascript, langchain, frontend, message-queues]
---
...
> **Interactive example:** [Open it in the original LangChain documentation](https://docs.langchain.com/oss/javascript/langchain/frontend/message-queues).
