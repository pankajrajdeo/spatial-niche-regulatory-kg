...
description: "Structured output allows agents to return data in a specific, predictable format. Instead of parsing natural language responses, you get typed structured data."
source: "https://docs.langchain.com/oss/javascript/langchain/structured-output"
category: "docs"
tags: [docs, javascript, langchain, structured-output]
---
...
> [!TIP]
> This page covers structured output with agents using `createAgent`. To use structured output directly on a model (outside of agents), see [Models - Structured output](models.md#structured-output).
