...
category: "docs"
tags: [docs, javascript, integrations, vectorstores, neo4jvector]
---

# Neo4j vector index integration

> Integrate with the Neo4j vector index vector store using LangChain JavaScript.
...
This guide helps you get started with the Neo4j [vector store](../vectorstores.md). For detailed documentation of all `Neo4jVectorStore` features and configurations, see the [API reference](https://reference.langchain.com/javascript/langchain-neo4j/Neo4jVectorStore).
...
Install `@langchain/neo4j`, the MongoDB-compatible `neo4j-driver`, `@langchain/core`, and an embeddings provider (this guide uses [OpenAI embeddings](../embeddings/openai.md)):
