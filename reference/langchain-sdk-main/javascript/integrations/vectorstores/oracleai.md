...
source: "https://docs.langchain.com/oss/javascript/integrations/vectorstores/oracleai"
category: "docs"
tags: [docs, javascript, integrations, vectorstores, oracleai]
---
...
The example below assumes that you already created a table with vector and metadata columns and generated embeddings using [`OracleEmbeddings`](../embeddings/oracleai.md).
...
* Load content with [`OracleDocLoader`](../document_loaders/file_loaders/oracleai.md)
* Generate embeddings with [`OracleEmbeddings`](../embeddings/oracleai.md)
* Summarize documents using [`OracleSummary`](../tools/oracleai.md)
