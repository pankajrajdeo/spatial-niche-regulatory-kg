...
category: "docs"
tags: [docs, javascript, integrations, vectorstores, redis]
---
...
This guide provides a quick overview for getting started with Redis [vector stores](../vectorstores.md). The `@langchain/redis` package provides two implementations: `FluentRedisVectorStore` (recommended, with advanced filtering) and `RedisVectorStore` (legacy).
