...
category: "docs"
tags: [docs, javascript, integrations, vectorstores, memory]
---

# MemoryVectorStore integration

> Integrate with the MemoryVectorStore using LangChain JavaScript.
...
This guide provides a quick overview for getting started with `MemoryVectorStore` [vector stores](../vectorstores.md).
...
This guide will also use [OpenAI embeddings](../embeddings/openai.md), which require you to install the `@langchain/openai` integration package. You can also use [other supported embeddings models](../embeddings.md) if you wish.
