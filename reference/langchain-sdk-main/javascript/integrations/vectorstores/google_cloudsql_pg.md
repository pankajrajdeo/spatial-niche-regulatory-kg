...
category: "docs"
tags: [docs, javascript, integrations, vectorstores, google_cloudsql_pg]
---

# Google cloud SQL for postgresql integration

> Integrate with the Google cloud SQL for postgresql vector store using LangChain JavaScript.
