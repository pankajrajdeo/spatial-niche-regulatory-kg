...
category: "docs"
tags: [docs, javascript, integrations, vectorstores, azure_cosmosdb_nosql]
---

# Azure Cosmos DB for NoSQL integration

> Integrate with the Azure Cosmos DB for NoSQL vector store using LangChain JavaScript.
