...
source: "https://docs.langchain.com/oss/javascript/integrations/vectorstores/ydb"
category: "docs"
tags: [docs, javascript, integrations, vectorstores, ydb]
---
...
This guide provides a quick overview for getting started with the `YDBVectorStore` [vector store](../vectorstores.md). For detailed documentation of all features and configurations, head to the [YDB LangChain.js guide](https://ydb.js.org/guide/langchain/).
