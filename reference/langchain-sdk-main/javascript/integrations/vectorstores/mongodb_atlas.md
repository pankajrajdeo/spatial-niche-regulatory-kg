...
category: "docs"
tags: [docs, javascript, integrations, vectorstores, mongodb_atlas]
---

# MongoDB Atlas integration

> Integrate with the MongoDB Atlas vector store using LangChain JavaScript.
...
In **manual embedding mode**, you provide an embeddings model and embed documents client-side. This guide uses [OpenAI embeddings](../embeddings/openai.md) as an example. You can also use [other supported embeddings models](../embeddings.md).
