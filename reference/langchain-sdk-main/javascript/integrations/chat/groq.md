...
source: "https://docs.langchain.com/oss/javascript/integrations/chat/groq"
category: "docs"
tags: [docs, javascript, integrations, chat, groq]
---

# ChatGroq integration

> Integrate with the ChatGroq chat model using LangChain JavaScript.
...
This page helps you get started with Groq [chat models](../../langchain/models.md). For detailed documentation of all `ChatGroq` features and configurations, see the [API reference](https://reference.langchain.com/javascript/langchain-groq/ChatGroq).
