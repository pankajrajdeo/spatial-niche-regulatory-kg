...
category: "docs"
tags: [docs, javascript, integrations, chat, deepseek]
---
...
This will help you getting started with `ChatDeepSeek` [chat models](../../langchain/models.md). For detailed documentation of all `ChatDeepSeek` features and configurations head to the [API reference](https://reference.langchain.com/javascript/langchain-deepseek/ChatDeepSeek).
...
You can also access the DeepSeek API through providers like [Ollama](ollama.md).
