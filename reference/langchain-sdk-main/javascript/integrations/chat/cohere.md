...
category: "docs"
tags: [docs, javascript, integrations, chat, cohere]
---

# ChatCohere integration

> Integrate with the ChatCohere chat model using LangChain JavaScript.
...
This will help you getting started with `ChatCohere` [chat models](../../langchain/models.md). For detailed documentation of all `ChatCohere` features and configurations head to the [API reference](https://reference.langchain.com/javascript/langchain-cohere/ChatCohere).
