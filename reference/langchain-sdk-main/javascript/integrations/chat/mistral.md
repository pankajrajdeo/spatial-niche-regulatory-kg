...
category: "docs"
tags: [docs, javascript, integrations, chat, mistral]
---

# ChatMistralAI integration

> Integrate with the ChatMistralAI chat model using LangChain JavaScript.
...
This will help you getting started with Mistral [chat models](../../langchain/models.md). For detailed documentation of all `ChatMistralAI` features and configurations head to the [API reference](https://reference.langchain.com/javascript/langchain-mistralai/ChatMistralAI).
...
Mistral's API supports [tool calling](../../langchain/tools.md) for a subset of their models. You can see which models support tool calling [on this page](https://docs.mistral.ai/capabilities/function_calling/).
