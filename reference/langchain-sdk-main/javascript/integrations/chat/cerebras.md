...
category: "docs"
tags: [docs, javascript, integrations, chat, cerebras]
---
...
This will help you getting started with `ChatCerebras` [chat models](../../langchain/models.md). For detailed documentation of all `ChatCerebras` features and configurations head to the [API reference](https://reference.langchain.com/javascript/langchain-cerebras/ChatCerebras).
