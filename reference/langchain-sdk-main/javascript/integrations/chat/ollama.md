...
category: "docs"
tags: [docs, javascript, integrations, chat, ollama]
---

# ChatOllama integration

> Integrate with the ChatOllama chat model using LangChain JavaScript.
...
This guide will help you getting started with `ChatOllama` [chat models](../../langchain/models.md). For detailed documentation of all `ChatOllama` features and configurations head to the [API reference](https://reference.langchain.com/javascript/langchain-ollama/ChatOllama).
...
You can pass images as part of a message's `content` field to [multimodal-capable](../../langchain/messages.md#multimodal) models like this:
