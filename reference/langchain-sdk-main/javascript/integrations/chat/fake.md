...
source: "https://docs.langchain.com/oss/javascript/integrations/chat/fake"
category: "docs"
tags: [docs, javascript, integrations, chat, fake]
---

# Fake integration

> Integrate with the Fake chat model using LangChain JavaScript.
...
* Chat model [conceptual guide](../../langchain/models.md)
* Chat model [how-to guides](../../langchain/models.md)
