...
category: "docs"
tags: [docs, javascript, integrations, chat, azure]
---
...
This will help you getting started with `AzureChatOpenAI` [chat models](../../langchain/models.md). For detailed documentation of all `AzureChatOpenAI` features and configurations head to the [API reference](https://reference.langchain.com/javascript/langchain-openai/AzureChatOpenAI).
