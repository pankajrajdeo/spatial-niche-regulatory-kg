...
category: "docs"
tags: [docs, javascript, integrations, chat, google]
---
...
[Gemini Enterprise Agent Platform](https://cloud.google.com/products/gemini-enterprise-agent-platform) service.

This will help you getting started with `ChatGoogle` [chat models](../../langchain/models.md).
...
> It replaces the older [`@langchain/google-genai`](google_generative_ai.md)
> and [`@langchain/google-vertexai`](google_vertex_ai.md) packages.
> See [legacy packages](../providers/google.md#legacy-packages) for migration details.
...
### Credentials through Gemini Enterprise Agent Platform Express Mode (API Key)

Gemini Enterprise Agent Platform also supports [Express Mode](https://docs.cloud.google.com/gemini-enterprise-agent-platform/machine-learning#express-mode),
which allows you to use an API key for authentication. You can obtain a Gemini Enterprise Agent Platform
...
When using [Gemini Enterprise Agent Platform Express Mode](https://docs.cloud.google.com/gemini-enterprise-agent-platform/models/start/express-mode/overview), you will also need to specify the platform
...
### Credentials through Gemini Enterprise Agent Platform (OAuth Application Default Credentials / ADC)
...
### Credentials through Gemini Enterprise Agent Platform (OAuth saved credentials)
...
your [LangSmith](../../../langsmith/observability.md) API key by uncommenting below:
...
The model will automatically determine whether to use the Google AI API or Gemini Enterprise Agent Platform based on your configuration:

* If you provide an `apiKey` (or set `GOOGLE_API_KEY`), it defaults to Google AI.
* If you provide `credentials` (or set `GOOGLE_APPLICATION_CREDENTIALS` / `GOOGLE_CLOUD_CREDENTIALS` in Node), it defaults to Gemini Enterprise Agent Platform.
...
To use Gemini Enterprise Agent Platform with an API key (Express Mode), you must explicitly set the `platformType`.
...
`ChatGoogle` supports standard LangChain [tool calling](../../langchain/tools.md) as
...
If you are using Gemini Enterprise Agent Platform (`platformType: "gcp"`), you can ground responses using
an Agent Search data store.
