...
category: "docs"
tags: [docs, javascript, integrations, providers, openai]
---
...
See a [usage example](../chat/openai.md).
...
See a [usage example](../llms/openai.md).
...
See a [usage example](../embeddings/openai.md)
