...
category: "docs"
tags: [docs, javascript, integrations, providers, microsoft]
---
...
See a [usage example](../chat/azure.md)
...
See a [usage example](../llms/azure.md).
...
See a [usage example](../vectorstores/azure_cosmosdb_nosql.md).
...
See a [usage example](../vectorstores/azure_documentdb.md).
...
See a [usage example](../llm_caching/azure_cosmosdb_nosql.md).
