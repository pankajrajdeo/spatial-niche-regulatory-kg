...
source: "https://docs.langchain.com/oss/javascript/integrations/retrievers/kendra-retriever"
category: "docs"
tags: [docs, javascript, integrations, retrievers, kendra-retriever]
---
...
This will help you getting started with `AWSKendraRetriever` [retrieval](../../deepagents/retrieval.md). For detailed documentation of all `AWSKendraRetriever` features and configurations head to the [API reference](https://reference.langchain.com/javascript/langchain-aws/AmazonKendraRetriever).
