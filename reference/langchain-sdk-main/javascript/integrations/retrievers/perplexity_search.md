...
description: "Integrate with the PerplexitySearchRetriever retriever using LangChain JavaScript."
source: "https://docs.langchain.com/oss/javascript/integrations/retrievers/perplexity_search"
category: "docs"
tags: [docs, javascript, integrations, retrievers, perplexity_search]
---
...
This will help you get started with `PerplexitySearchRetriever` [retrieval](../../deepagents/retrieval.md). For detailed documentation of all `PerplexitySearchRetriever` features and configurations head to the [API reference](https://reference.langchain.com/javascript/langchain-perplexity/PerplexitySearchRetriever).
...
Like other retrievers, `PerplexitySearchRetriever` can be incorporated into LLM applications via [chains](../../deepagents/retrieval.md).
