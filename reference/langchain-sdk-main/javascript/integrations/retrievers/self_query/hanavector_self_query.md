...
description: "For setup details of the SAP HANA vector store, see the guide at Vector Store: SAP HANA."
source: "https://docs.langchain.com/oss/javascript/integrations/retrievers/self_query/hanavector_self_query"
category: "docs"
tags: [docs, javascript, integrations, retrievers, self_query, hanavector_self_query]
---

# Self Querying with SAP HANA Cloud Vector Engine

For setup details of the SAP HANA vector store, see the guide at [Vector Store: SAP HANA](../../vectorstores/sap_hanavector.md).
