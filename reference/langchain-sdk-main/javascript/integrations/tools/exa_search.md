...
category: "docs"
tags: [docs, javascript, integrations, tools, exa_search]
---

# ExaSearchResults integration

> Integrate with the ExaSearchResults tool using LangChain JavaScript.
...
We can use our tool in a chain by first binding it to a [tool-calling model](../../langchain/tools.md) and then calling it:
