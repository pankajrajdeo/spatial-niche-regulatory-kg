...
category: "docs"
tags: [docs, javascript, integrations, tools, vectorstore]
---

# VectorStoreToolkit integration

> Integrate with the VectorStoreToolkit tool using LangChain JavaScript.

This will help you getting started with `VectorStoreToolkit` [toolkits](../../langchain/tools.md#prebuilt-tools). For detailed documentation of all `VectorStoreToolkit` features and configurations head to the [API reference](https://reference.langchain.com/javascript/langchain-core/vectorstores/VectorStore).
...
If you want to get automated tracing from runs of individual tools, you can also set your [LangSmith](../../../langsmith/observability.md) API key by uncommenting below:
