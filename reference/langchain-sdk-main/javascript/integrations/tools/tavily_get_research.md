...
source: "https://docs.langchain.com/oss/javascript/integrations/tools/tavily_get_research"
category: "docs"
tags: [docs, javascript, integrations, tools, tavily_get_research]
---
...
Use this tool after [TavilyResearch](tavily_research.md) to poll for status and fetch completed results.

## Overview

### Integration details

| Class                                                                                                | Package                                                                | [PY support](tavily_search.md) |                                             Downloads                                             |                                             Version                                            |
| :--------------------------------------------------------------------------------------------------- | :--------------------------------------------------------------------- | :------------------------------------------------------------: | :-----------------------------------------------------------------------------------------------: | :--------------------------------------------------------------------------------------------: |
