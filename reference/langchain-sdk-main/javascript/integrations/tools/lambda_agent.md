...
source: "https://docs.langchain.com/oss/javascript/integrations/tools/lambda_agent"
category: "docs"
tags: [docs, javascript, integrations, tools, lambda_agent]
---

# Agent with AWS lambda integration

> Integrate with the Agent with AWS lambda tool using LangChain JavaScript.
