...
category: "docs"
tags: [docs, javascript, integrations, tools, openapi]
---
...
This will help you getting started with `OpenApiToolkit` [OpenAPI toolkit](openapi.md). `OpenApiToolkit` now lives in `@langchain/classic`. For migration details, see the [LangChain v1 migration guide](../../migrate/langchain-v1.md).
