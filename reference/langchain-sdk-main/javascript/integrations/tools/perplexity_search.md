...
source: "https://docs.langchain.com/oss/javascript/integrations/tools/perplexity_search"
category: "docs"
tags: [docs, javascript, integrations, tools, perplexity_search]
---
...
The [Perplexity Search API](https://docs.perplexity.ai/docs/search/quickstart) returns real-time, grounded web search results. `PerplexitySearchResults` is a LangChain [tool](../tools.md) wrapper that lets agents query the API and receive a JSON array of search results.
