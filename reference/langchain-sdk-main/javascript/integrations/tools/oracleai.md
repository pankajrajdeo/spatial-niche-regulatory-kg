...
source: "https://docs.langchain.com/oss/javascript/integrations/tools/oracleai"
category: "docs"
tags: [docs, javascript, integrations, tools, oracleai]
---
...
* Chunk and normalize with [`OracleTextSplitter`](../document_loaders/file_loaders/oracleai.md#chunk-documents)
* Generate embeddings using [`OracleEmbeddings`](../embeddings/oracleai.md) and store them in [`OracleVS`](../vectorstores/oracleai.md)
