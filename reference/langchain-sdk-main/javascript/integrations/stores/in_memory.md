...
source: "https://docs.langchain.com/oss/javascript/integrations/stores/in_memory"
category: "docs"
tags: [docs, javascript, integrations, stores, in_memory]
---
...
This will help you get started with [InMemoryStore](../stores.md). For detailed documentation of all `InMemoryStore` features and configurations head to the [API reference](https://reference.langchain.com/javascript/langchain-core/stores/InMemoryStore).
