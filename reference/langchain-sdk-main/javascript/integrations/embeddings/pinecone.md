...
category: "docs"
tags: [docs, javascript, integrations, embeddings, pinecone]
---

# PineconeEmbeddings integration

> Integrate with the PineconeEmbeddings embedding model using LangChain JavaScript.

This will help you get started with PineconeEmbeddings [embedding models](../embeddings.md) using LangChain. For detailed documentation on `PineconeEmbeddings` features and configuration options, please refer to the [API reference](https://reference.langchain.com/javascript/langchain-pinecone/PineconeEmbeddings).
...
To access Pinecone embedding models, create a Pinecone account, get an API key, and install the `@langchain/pinecone` integration package.
