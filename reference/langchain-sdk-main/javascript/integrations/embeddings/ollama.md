...
category: "docs"
tags: [docs, javascript, integrations, embeddings, ollama]
---
...
This will help you get started with Ollama [embedding models](../embeddings.md) using LangChain. For detailed documentation on `OllamaEmbeddings` features and configuration options, please refer to the [API reference](https://reference.langchain.com/javascript/langchain-ollama/OllamaEmbeddings).
