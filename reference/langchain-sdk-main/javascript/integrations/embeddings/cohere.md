...
category: "docs"
tags: [docs, javascript, integrations, embeddings, cohere]
---

# CohereEmbeddings integration

> Integrate with the CohereEmbeddings embedding model using LangChain JavaScript.

This will help you get started with CohereEmbeddings [embedding models](../embeddings.md) using LangChain. For detailed documentation on `CohereEmbeddings` features and configuration options, please refer to the [API reference](https://reference.langchain.com/javascript/langchain-cohere/CohereEmbeddings).
...
We can instantiate a custom `CohereClient` and pass it to the `CohereEmbeddings` constructor.
