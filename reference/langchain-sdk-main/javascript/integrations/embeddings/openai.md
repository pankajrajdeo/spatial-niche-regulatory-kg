...
category: "docs"
tags: [docs, javascript, integrations, embeddings, openai]
---
...
This will help you get started with OpenAIEmbeddings [embedding models](../embeddings.md) using LangChain. For detailed documentation on `OpenAIEmbeddings` features and configuration options, please refer to the [API reference](https://reference.langchain.com/javascript/langchain-openai/OpenAIEmbeddings).
...
If you are hosting on Azure OpenAI, see the [dedicated page instead](azure_openai.md).
