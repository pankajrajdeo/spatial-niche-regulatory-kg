...
source: "https://docs.langchain.com/oss/javascript/integrations/embeddings/togetherai"
category: "docs"
tags: [docs, javascript, integrations, embeddings, togetherai]
---
...
This will help you get started with TogetherAIEmbeddings [embedding models](../embeddings.md) using LangChain. For detailed documentation on `TogetherAIEmbeddings` features and configuration options, please refer to the [API reference](https://reference.langchain.com/javascript/langchain-together-ai/TogetherAIEmbeddings).
