...
source: "https://docs.langchain.com/oss/javascript/integrations/embeddings/google_generative_ai"
category: "docs"
tags: [docs, javascript, integrations, embeddings, google_generative_ai]
---

# GoogleGenerativeAIEmbeddings integration

> Integrate with the GoogleGenerativeAIEmbeddings embedding model using LangChain JavaScript.

This will help you get started with Google Generative AI [embedding models](../embeddings.md) using LangChain. For detailed documentation on `GoogleGenerativeAIEmbeddings` features and configuration options, please refer to the [API reference](https://reference.langchain.com/javascript/langchain-google-genai/GoogleGenerativeAIEmbeddings).
