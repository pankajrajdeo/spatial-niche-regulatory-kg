...
category: "docs"
tags: [docs, javascript, integrations, embeddings, bedrock]
---
...
This will help you get started with Amazon Bedrock [embedding models](../embeddings.md) using LangChain. For detailed documentation on `Bedrock` features and configuration options, please refer to the [API reference](https://reference.langchain.com/javascript/langchain-aws/BedrockEmbeddings).
