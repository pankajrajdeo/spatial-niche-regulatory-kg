...
source: "https://docs.langchain.com/oss/javascript/integrations/embeddings/cloudflare_ai"
category: "docs"
tags: [docs, javascript, integrations, embeddings, cloudflare_ai]
---
...
Below is an example worker that uses Workers AI embeddings with a [Cloudflare Vectorize vectorstore](../vectorstores/cloudflare_vectorize.md).
