...
source: "https://docs.langchain.com/oss/javascript/integrations/memory/mongodb-long-term-memory"
category: "docs"
tags: [docs, javascript, integrations, memory, mongodb-long-term-memory]
---
...
[Long-term memory](../../langchain/long-term-memory.md) lets your agent store and recall information across different conversations and sessions. This guide shows how to use [MongoDB Atlas](https://www.mongodb.com/docs/atlas/) as the persistent store backend.
...
> [!TIP]
> For a deeper dive into memory types and strategies for writing memories, see the [Memory conceptual guide](../../concepts/memory.md#long-term-memory).
...
For more information about store operations, see the [Stores](../../langgraph/stores.md) guide.
...
* [Long-term memory](../../langchain/long-term-memory.md)
* [Stores](../../langgraph/stores.md)
* [Store integrations](../long-term-memory.md)
* [Short-term memory with MongoDB Atlas](mongodb-short-term-memory.md)
