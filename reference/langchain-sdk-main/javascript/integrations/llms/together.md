...
source: "https://docs.langchain.com/oss/javascript/integrations/llms/together"
category: "docs"
tags: [docs, javascript, integrations, llms, together]
---
...
> [!WARNING]
> **You are currently on a page documenting the use of Together AI models as text completion models. Many popular models available on Together AI are [chat completion models](../../langchain/models.md).**
>
> You may be looking for [this page instead](../chat/togetherai.md).
...
To access the legacy `TogetherAI` completions class, create a Together account, [get an API key](https://api.together.xyz/), and install the `@langchain/together-ai` integration package. For chat and instruct models, prefer [`ChatTogetherAI`](../chat/togetherai.md).
