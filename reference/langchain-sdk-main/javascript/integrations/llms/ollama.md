...
source: "https://docs.langchain.com/oss/javascript/integrations/llms/ollama"
category: "docs"
tags: [docs, javascript, integrations, llms, ollama]
---
...
> [!WARNING]
> **You are currently on a page documenting the use of Ollama models as text completion models. Many popular models available on Ollama are [chat completion models](../../langchain/models.md).**
>
...
To access Ollama LLM models, follow [these instructions](https://github.com/ollama/ollama) to install Ollama, then install the `@langchain/ollama` integration package.
