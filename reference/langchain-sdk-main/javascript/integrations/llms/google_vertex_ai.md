...
description: "Integrate with the Gemini Enterprise Agent Platform LLM using LangChain JavaScript."
source: "https://docs.langchain.com/oss/javascript/integrations/llms/google_vertex_ai"
category: "docs"
tags: [docs, javascript, integrations, llms, google_vertex_ai]
---

# Gemini Enterprise Agent Platform integration

> Integrate with the Gemini Enterprise Agent Platform LLM using LangChain JavaScript.

> [!WARNING]
> **You are currently on a page documenting the use of Gemini Enterprise Agent Platform models as text completion models. Many popular models available on Gemini Enterprise Agent Platform are [chat completion models](../../langchain/models.md).**
>
...
This will help you get started with Gemini Enterprise Agent Platform completion models (LLMs) using LangChain. For detailed documentation on `VertexAI` features and configuration options, please refer to the [API reference](https://reference.langchain.com/javascript/langchain-google-vertexai/index/VertexAI).
...
To access Gemini Enterprise Agent Platform models you'll need to create a Google Cloud Platform (GCP) account, get an API key, and install the `@langchain/google-vertexai` integration package. On Node.js, that package uses [`@langchain/google-gauth`](https://github.com/langchain-ai/langchainjs/tree/main/libs/providers/langchain-google-gauth) for authentication (you do not need to install it separately).

### Credentials

#### Node.js

You should make sure the Gemini Enterprise Agent Platform API is
...
To call Gemini Enterprise Agent Platform models in web environments (like Edge functions), you'll need to install
