...
category: "docs"
tags: [docs, javascript, langgraph, test]
---
...
Note that this guide is LangGraph-specific and covers scenarios around graphs with custom structures - if you are just getting started, check out [Test](../langchain/test.md) that uses LangChain's built-in [`createAgent`](https://reference.langchain.com/javascript/langchain/index/createAgent) instead.
...
2. Call your agent's [`update_state`](use-time-travel.md) method with an [`asNode`](use-time-travel.md#from-a-specific-node) parameter set to the name of the node *before* the one you want to start your test.
