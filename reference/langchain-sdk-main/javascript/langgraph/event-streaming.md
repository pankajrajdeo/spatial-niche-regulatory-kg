...
category: "docs"
tags: [docs, javascript, langgraph, event-streaming]
---
...
| Need                                           | Use                          |
| ---------------------------------------------- | ---------------------------- |
| Side-channel projection only                   | `new StreamChannel()`     |
| Also flow each push into the main event stream | `new StreamChannel(name)` |
