...
category: "docs"
tags: [docs, integrations, document_loaders, google_cloud_sql_mysql]
---

# Google cloud SQL for mysql integration

> Integrate with the Google cloud SQL for mysql document loader using LangChain Python.
...
This notebook goes over how to use [Cloud SQL for MySQL](https://cloud.google.com/sql/mysql) to [save, load and delete langchain documents](../document_loaders.md) with `MySQLLoader` and `MySQLDocumentSaver`.
