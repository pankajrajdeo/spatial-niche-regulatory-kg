...
category: "docs"
tags: [docs, integrations, document_loaders, google_spanner]
---
...
This notebook goes over how to use [Spanner](https://cloud.google.com/spanner) to [save, load and delete langchain documents](../document_loaders.md) with `SpannerLoader` and `SpannerDocumentSaver`.
