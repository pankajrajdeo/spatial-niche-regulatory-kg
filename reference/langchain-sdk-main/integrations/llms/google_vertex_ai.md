...
> [!WARNING]
> **You are currently on a page documenting the use of Gemini Enterprise Agent Platform text completion models. Many models available through Google Cloud are [chat completion models](../../langchain/models.md).**
>
> You may be looking for [this page instead](../chat/google_vertex_ai.md).

**Note:** This is separate from the `Google Generative AI` integration, it exposes [Generative AI on Gemini Enterprise Agent Platform](https://docs.cloud.google.com/gemini-enterprise-agent-platform/models/beginners-guide) on `Google Cloud`.

Gemini Enterprise Agent Platform exposes all foundational models available in Google Cloud.

For a full and updated list of available models visit [Gemini Enterprise Agent Platform documentation](https://docs.cloud.google.com/gemini-enterprise-agent-platform/models/google-models)

## Setup

By default, Google Cloud [does not use](https://docs.cloud.google.com/gemini-enterprise-agent-platform/resources/zero-data-retention#foundation_model_development) customer data to train its foundation models as part of Google Cloud's AI/ML Privacy Commitment. More details about how Google processes data can also be found in [Google's Customer Data Processing Addendum (CDPA)](https://cloud.google.com/terms/data-processing-addendum).

To use `Generative AI on Gemini Enterprise Agent Platform` you must have the `langchain-google-vertexai` Python package installed and either:
...
The `VertexAI` class supports all [LLM](../../langchain/models.md) functionality.
...
We can use the `generate` method to get back extra metadata like [safety attributes](https://docs.cloud.google.com/gemini-enterprise-agent-platform/models/responsible-ai#safety_attribute_confidence_scoring) and not just text completions.
...
### OPTIONAL : Managing [Safety Attributes](https://docs.cloud.google.com/gemini-enterprise-agent-platform/models/responsible-ai#safety_attribute_confidence_scoring)
...
For an updated list of available models visit [Gemini Enterprise Agent Platform documentation](https://docs.cloud.google.com/gemini-enterprise-agent-platform/reference/models/inference)
...
<p>
  <img src="https://mintcdn.com/langchain-5e9cc07a/x_qjL89cw5RbZp-3/images/integrations/vertex-ai-image-example.jpg?fit=max&auto=format&n=x_qjL89cw5RbZp-3&q=85&s=50794830baf93129dc9a92f0fa8ab85f" width="602" height="800" data-path="images/integrations/vertex-ai-image-example.jpg" />
</p>
...
Gemini Enterprise Agent Platform Model Garden [exposes](https://docs.cloud.google.com/gemini-enterprise-agent-platform/models/model-garden/explore-models) open-sourced models that can be deployed and served on Gemini Enterprise Agent Platform.

Hundreds popular [open-sourced models](https://docs.cloud.google.com/gemini-enterprise-agent-platform/models/model-garden/explore-models#oss-models) like Llama, Falcon and are available for  [One Click Deployment](https://docs.cloud.google.com/gemini-enterprise-agent-platform/models/deploy/overview)

If you have successfully deployed a model from Gemini Enterprise Agent Platform Model Garden, you can find a corresponding Gemini Enterprise Agent Platform [endpoint](https://docs.cloud.google.com/gemini-enterprise-agent-platform/machine-learning/general/deployment#what_happens_when_you_deploy_a_model) in the console or via API.
...
> Llama is a family of open weight models developed by Meta that you can fine-tune and deploy on Gemini Enterprise Agent Platform. Llama models are pre-trained and fine-tuned generative text models. You can deploy Llama 2 and Llama 3 models on Gemini Enterprise Agent Platform.
> [Official documentation](https://docs.cloud.google.com/gemini-enterprise-agent-platform/models/open-models/use-llama) for more information about Llama on [Gemini Enterprise Agent Platform Model Garden](https://docs.cloud.google.com/gemini-enterprise-agent-platform/models/model-garden/explore-models)

To use Llama on Gemini Enterprise Agent Platform Model Garden you must first [deploy it to Gemini Enterprise Agent Platform endpoint](https://docs.cloud.google.com/gemini-enterprise-agent-platform/models/model-garden/explore-models#deploy-a-model)
...
> Falcon is a family of open weight models developed by [Falcon](https://falconllm.tii.ae/) that you can fine-tune and deploy on Gemini Enterprise Agent Platform. Falcon models are pre-trained and fine-tuned generative text models.

To use Falcon on Gemini Enterprise Agent Platform Model Garden you must first [deploy it to Gemini Enterprise Agent Platform endpoint](https://docs.cloud.google.com/gemini-enterprise-agent-platform/models/model-garden/explore-models#deploy-a-model)
