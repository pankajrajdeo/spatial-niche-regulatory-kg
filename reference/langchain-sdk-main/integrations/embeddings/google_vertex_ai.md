...
description: "Integrate with the Gemini Enterprise Agent Platform embedding model using LangChain Python."
source: "https://docs.langchain.com/oss/python/integrations/embeddings/google_vertex_ai"
category: "docs"
tags: [docs, integrations, embeddings, google_vertex_ai]
---

# Gemini Enterprise Agent Platform integration

> Integrate with the Gemini Enterprise Agent Platform embedding model using LangChain Python.
...
To access embedding models on Gemini Enterprise Agent Platform you'll need to
...
**Set Google Cloud project information and initialize Gemini Enterprise Agent Platform SDK**

To get started using Gemini Enterprise Agent Platform, you must have an existing Google Cloud project and [enable the Gemini Enterprise Agent Platform API](https://console.cloud.google.com/flows/enableapi?apiid=aiplatform.googleapis.com).
...
> Check the list of [Supported Models](https://docs.cloud.google.com/gemini-enterprise-agent-platform/models/embeddings/get-text-embeddings#supported-models)
...
For detailed documentation on `VertexAIEmbeddings` features and configuration options, please refer to the [API reference](https://reference.langchain.com/python/langchain-google-vertexai/embeddings/VertexAIEmbeddings).
