...
[Browserbase](https://browserbase.com) is the complete platform to run agents that use the web like humans.
...
* Get an API key from [browserbase.com](https://browserbase.com) and set it in the `BROWSERBASE_API_KEY` environment variable.
