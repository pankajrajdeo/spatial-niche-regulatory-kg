...
source: "https://docs.langchain.com/oss/python/integrations/checkpointers"
category: "docs"
...
To implement your own checkpointer for a custom storage backend, see [Build a custom checkpointer](../langgraph/checkpointers.md#build-a-custom-checkpointer).
...
| [MongoDB](memory/mongodb-short-term-memory.md)                             | [`langgraph-checkpoint-mongodb`](https://pypi.org/project/langgraph-checkpoint-mongodb/)       | [langchain-ai/langchain-mongodb](https://github.com/langchain-ai/langchain-mongodb/tree/main/libs/langgraph-checkpoint-mongodb) |
...
| [Cockroach DB](providers/cockroachdb.md#langgraph-checkpointer)            | [`langchain-cockroachdb`](https://pypi.org/project/langchain-cockroachdb/)                     | [cockroachdb/langchain-cockroachdb](https://github.com/cockroachdb/langchain-cockroachdb)                                       |
| [Aerospike](providers/aerospike.md#langgraph-checkpointer)                 | [`langgraph-checkpoint-aerospike`](https://pypi.org/project/langgraph-checkpoint-aerospike/)   | [aerospike-community/aerospike-langgraph](https://github.com/aerospike-community/aerospike-langgraph)                           |
