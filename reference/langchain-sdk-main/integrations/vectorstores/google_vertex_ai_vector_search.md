...
This page covers how to use Vector Search on Gemini Enterprise Agent Platform as a vector store in LangChain.

## Overview

[Vector Search on Gemini Enterprise Agent Platform](https://docs.cloud.google.com/gemini-enterprise-agent-platform/build/vector-search/overview) is a fully managed, high-scale, low-latency solution for finding similar vectors. It supports both exact and approximate nearest neighbor (ANN) search using Google's ScaNN (Scalable Nearest Neighbors) technology.

Vector Search on Gemini Enterprise Agent Platform is available in two versions:

* **[Vector Search 2.0](https://docs.cloud.google.com/gemini-enterprise-agent-platform/build/vector-search-2/overview)**: Uses Collections to store Data Objects containing vectors, metadata, and content together. Provides a unified data model with simpler and quicker operations.
* **[Vector Search 1.0](https://docs.cloud.google.com/gemini-enterprise-agent-platform/build/vector-search/overview)**: Uses Indexes deployed to Endpoints with separate document storage in Google Cloud Storage or Datastore.
...
For migrating from Vector Search on Gemini Enterprise Agent Platform 1.0 to 2.0, see the [Migration Guide](https://docs.cloud.google.com/gemini-enterprise-agent-platform/build/vector-search-2/migration-from-vs-1_0).

## Installation

Install the LangChain Gemini Enterprise Agent Platform integration:
...
* Google Cloud project with Gemini Enterprise Agent Platform API and Vector Search APIs enabled
...
docs = [
    Document(
        page_content="Gemini Enterprise Agent Platform is a managed machine learning platform",
        metadata={"source": "docs", "category": "AI"}
    ),
    Document(
        page_content="LangChain integrates with Vector Search on Gemini Enterprise Agent Platform",
...
```python
texts = [
    "Gemini Enterprise Agent Platform provides scalable ML infrastructure",
...
```python
# Basic similarity search
query = "What is Gemini Enterprise Agent Platform?"
...
embedding = embeddings.embed_query("Feature Store on Gemini Enterprise Agent Platform")
...
See the [Vector Search 2.0 query documentation](https://docs.cloud.google.com/gemini-enterprise-agent-platform/build/vector-search-2/query-search/query) for more details.
...
Semantic search automatically generates embeddings from your query text using Gemini Enterprise Agent Platform models. Your collection must be configured with `vertex_embedding_config` in the vector schema.
...
See the [Vector Search 2.0 documentation](https://docs.cloud.google.com/gemini-enterprise-agent-platform/build/vector-search-2/overview) for more information.
...
* [Vector Search 2.0 Overview](https://docs.cloud.google.com/gemini-enterprise-agent-platform/build/vector-search-2/overview)
* [Vector Search 2.0 Collections](https://docs.cloud.google.com/gemini-enterprise-agent-platform/build/vector-search-2/collections/collections)
* [Vector Search 2.0 Data Objects](https://docs.cloud.google.com/gemini-enterprise-agent-platform/build/vector-search-2/data-objects/data-objects)
* [Vector Search 2.0 Search Guide](https://docs.cloud.google.com/gemini-enterprise-agent-platform/build/vector-search-2/query-search/search)
* [Vector Search 2.0 Query Guide](https://docs.cloud.google.com/gemini-enterprise-agent-platform/build/vector-search-2/query-search/query)
* [Vector Search 2.0 Migration Guide](https://docs.cloud.google.com/gemini-enterprise-agent-platform/build/vector-search-2/migration-from-vs-1_0)
...
This notebook shows how to use functionality related to the `Google Cloud Vector Search on Gemini Enterprise Agent Platform` vector database.

> [Vector Search on Gemini Enterprise Agent Platform](https://docs.cloud.google.com/gemini-enterprise-agent-platform/build/vector-search/overview), formerly known as Vertex AI Matching Engine, provides the industry's leading high-scale low latency vector database. These vector databases are commonly referred to as vector similarity-matching or an approximate nearest neighbor (ANN) service.
...
Refer [Official Documentation](https://docs.cloud.google.com/gemini-enterprise-agent-platform/build/vector-search/create-manage-index#create-index-batch) for more details on configuring indexes
...
<img src="https://mintcdn.com/langchain-5e9cc07a/x_qjL89cw5RbZp-3/images/integrations/vertex-ai-vector-search.png?fit=max&auto=format&n=x_qjL89cw5RbZp-3&q=85&s=422e1b75a74d838f469de76501610a1b" alt="Langchainassets.png" width="960" height="540" data-path="images/integrations/vertex-ai-vector-search.png" />
...
Read the [Gemini Enterprise Agent Platform hybrid search documentation](https://docs.cloud.google.com/gemini-enterprise-agent-platform/build/vector-search/about-hybrid-search) to learn more.
