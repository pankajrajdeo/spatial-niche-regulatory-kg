---
title: "Feature Store on Gemini Enterprise Agent Platform integration"
description: "Integrate with the Feature Store on Gemini Enterprise Agent Platform vector store using LangChain Python."
source: "https://docs.langchain.com/oss/python/integrations/vectorstores/google_vertex_ai_feature_store"
category: "docs"
tags: [docs, integrations, vectorstores, google_vertex_ai_feature_store]
---

# Feature Store on Gemini Enterprise Agent Platform integration

> Integrate with the Feature Store on Gemini Enterprise Agent Platform vector store using LangChain Python.

> [Google Cloud Vertex Feature Store](https://docs.cloud.google.com/gemini-enterprise-agent-platform/machine-learning/featurestore/latest/overview) streamlines your ML feature management and online serving processes by letting you serve at low-latency your data in [Google Cloud BigQuery](https://cloud.google.com/bigquery?hl=en), including the capacity to perform approximate neighbor retrieval for embeddings
...
<img src="https://mintcdn.com/langchain-5e9cc07a/x_qjL89cw5RbZp-3/images/integrations/bigquery-vertex-feature-store.png?fit=max&auto=format&n=x_qjL89cw5RbZp-3&q=85&s=818575b30c466ed0b11dbfe6d7cd587f" alt="Diagram BQ-VertexFS" width="1849" height="878" data-path="images/integrations/bigquery-vertex-feature-store.png" />
...
* If you are using **Gemini Enterprise Agent Platform Workbench**, check out the [Gemini Enterprise Agent Platform Workbench setup instructions](https://github.com/GoogleCloudPlatform/generative-ai/tree/main/setup-env).
...
You may need to enable Gemini Enterprise Agent Platform API in your project by running
