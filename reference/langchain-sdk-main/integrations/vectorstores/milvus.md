...
description: "Integrate with the Milvus vector store using LangChain Python."
source: "https://docs.langchain.com/oss/python/integrations/vectorstores/milvus"
category: "docs"
tags: [docs, integrations, vectorstores, milvus]
---
...
For a full list of all the search options available when using the `Milvus` vector store, you can visit the [API reference](https://reference.langchain.com/python/langchain-milvus/vectorstores/milvus/Milvus).
