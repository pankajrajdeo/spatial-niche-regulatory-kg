...
This page covers how to use the Valkey vector store with [Amazon ElastiCache for Valkey](https://aws.amazon.com/elasticache/) or [Amazon MemoryDB for Valkey](https://aws.amazon.com/memorydb/).
