...
> **API Reference**
>
> For detailed documentation of all features and configuration options, head to the [`ChatVertexAI`](https://reference.langchain.com/python/langchain-google-vertexai/chat_models/ChatVertexAI) API reference.
