...
Use Google Search grounding with Gemini Enterprise Agent Platform models (e.g., `gemini-3.6-flash`). Citations and metadata are returned in `response_metadata` (batch) or `additional_kwargs` (streaming).
