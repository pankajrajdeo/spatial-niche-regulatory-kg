...
category: "docs"
tags: [docs, integrations, chat, ollama]
---
...
Optionally, enable tracing of your model calls with [LangSmith](../../langsmith/observability.md) by setting the following environment variables:
...
Create a tool with the [`@tool`](https://reference.langchain.com/python/langchain-core/tools/convert/tool) decorator. For details, see [Customize tool properties](../../langchain/tools.md#customize-tool-properties).
