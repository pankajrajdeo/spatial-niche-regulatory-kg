...
MCP tools that return images or mixed content are converted the same way. See [Multimodal content](mcp/tools.md#multimodal-content).
...
For transports, authentication, multiple servers, and handling tool results, see [Model Context Protocol (MCP)](mcp.md).
