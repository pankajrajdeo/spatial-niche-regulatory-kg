...
description: "Discover Connery: open-source plugin infrastructure for LLM apps. Secure integrations, personalization, and human-in-the-loop control for AI agents."
source: "https://www.langchain.com/blog/meet-connery-an-open-source-plugin-infrastructure-for-opengpts-and-llm-apps"
category: "blog"
published: "2024-02-07T16:41:33.000Z"
author: "LangChain Accounts"
tags: [blog, meet-connery-an-open-source-plugin-infrastructure-for-opengpts-and-llm-apps]
---
...
2. **OpenGPT pulls actions:** The OpenGPT connects to Connery Runner through the [LangChain Toolkit](https://reference.langchain.com/python/langchain-community/agent_toolkits/connery/toolkit) and requests all available actions along with their metadata like action name, description, input names, descriptions, etc.
