...
source: "https://www.langchain.com/blog/insights-agent-multiturn-evals-langsmith"
category: "blog"
published: "2025-10-23T14:23:55.000Z"
author: "LangChain Accounts"
tags: [blog, insights-agent-multiturn-evals-langsmith]
---
...
Once you [trace your data](../langsmith/observability-quickstart.md) to LangSmith, you have a few options for how to categorize usage insights.
...
**Insights Agent is now generally available** for LangSmith Plus and Enterprise cloud customers. [Sign up for LangSmith](https://smith.langchain.com/?ref=blog.langchain.com) and [check out our docs](../langsmith/insights.md) to get started.
...
In LangSmith, we represent these multi-turn exchanges between users and agents as [**threads**](../langsmith/threads.md). If you’re already using threads, getting started is simple. Multi-turn evals run automatically once a conversation is complete, and you define the LLM-as-a-judge prompt to guide scoring.
...
**Multi-turn evals are live today for all LangSmith users.** [Visit our docs](../langsmith/online-evaluations.md#configure-multi-turn-online-evaluators) to get started.
