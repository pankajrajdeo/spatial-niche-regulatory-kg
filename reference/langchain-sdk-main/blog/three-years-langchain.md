...
description: "Harrison Chase on LangChain&#39;s 3-year journey from open source to $1.25B company, announcing LangChain 1.0, LangSmith expansion, and $125M funding."
source: "https://www.langchain.com/blog/three-years-langchain"
category: "blog"
published: "2025-10-20T14:34:32.000Z"
author: "LangChain Accounts"
tags: [blog, three-years-langchain]
---
...
We believe `langchain` 1.0, released today, solves the goals we had for it, and importantly gives the community of over a million developers a clearer view of what we stand behind. The best patterns for an agent architecture are far better understood today than when we started the project, and 1.0 is far more curated than anything you’ve seen from our team before. Plus, we shipped a [new centralized docs site](../home.md) which has been a long time coming! We hear you.
...
If you want to help us on our mission in building the agents of the future - [we’re hiring](https://www.langchain.com/careers) for basically all roles.
