...
description: "LangChain&#39;s standard message content enables provider-agnostic LLM apps. Switch between OpenAI, Anthropic, and Google with reasoning and citations."
source: "https://www.langchain.com/blog/standard-message-content"
category: "blog"
published: "2025-09-03T16:10:02.000Z"
author: "LangChain Accounts"
tags: [blog, standard-message-content]
---

# Standard message content

TLDR: We’ve introduced a [new view of message content](../langchain/messages.md#content) that standardizes reasoning, citations, server-side tool calls, and other modern LLM features across providers. This makes it easier to build applications that are agnostic of the inference provider, while taking advantage of the latest features of each. This feature is fully backward-compatible as it can be computed lazily from existing message content.
...
We’ve introduced new standard types for the latest LLM features, and exposed them on all LangChain message objects, making it easier to build provider-agnostic applications without sacrificing support for any available features. These features will be available in `langchain` 1.0 and are available for both [Python](../releases/langchain-v1.md) and [JS](../javascript/releases/langchain-v1.md).

[Standard content blocks](../langchain/messages.md#content) ensure that **identical capabilities are represented identically** across providers. In practice, they are a set of typed data structures that normalize message content across all LLM providers. They include:
...
**Ready to try it?** Check out our [migration guide](../releases/langchain-v1.md) and [technical docs](../langchain/messages.md#content).
