...
description: "Learn two architecture patterns for integrating AI agents with sandboxes: running agents inside vs. using sandboxes as tools. Compare trade-offs."
source: "https://www.langchain.com/blog/the-two-patterns-by-which-agents-connect-sandboxes"
category: "blog"
published: "2026-02-10T16:32:35.000Z"
author: "LangChain Accounts"
tags: [blog, the-two-patterns-by-which-agents-connect-sandboxes]
---
...
- [**deepagents**](../deepagents/overview.md)** supports both patterns with simple configuration**
...
To make these patterns concrete, we'll show examples using [deepagents](../deepagents/overview.md), an open-source agent framework with built-in sandbox support. Similar patterns apply to other agent frameworks.
