...
description: "Open SWE is an open-source, cloud-hosted coding agent that autonomously handles GitHub tasks—planning, coding, testing, and opening PRs."
...
tags: [blog, introducing-open-swe-an-open-source-asynchronous-coding-agent]
---
...
1. Visit [**swe.langchain.com**](https://github.com/langchain-ai/open-swe).
2. Connect your GitHub account and select the repositories you want Open SWE to access.
3. Provide your Anthropic API key in settings.
