...
tags: [blog, how-we-built-langchains-gtm-agent]
---
...
How it writes the email draft depends on the state of the relationship. The agent follows a defined outbound [skill](../deepagents/skills.md), a playbook it loads before drafting. The skill is designed to cover both warm and cold cases. An existing customer gets something different than a warm prospect, who gets something different than a cold contact. For cold outreach, the agent keeps it brief and research-backed, following a playbook we've defined in the skill.
