...
description: "Learn how LangChain rebuilt their chatbot using Deep Agents and subgraphs for sub-15-second responses with precise citations—and what you can apply."
source: "https://www.langchain.com/blog/rebuilding-chat-langchain"
category: "blog"
published: "2025-11-05T16:28:53.000Z"
author: "LangChain Accounts"
tags: [blog, rebuilding-chat-langchain]
---
...
We set out to solve this using the very tools we champion: **LangChain, LangGraph** and **LangSmith**. We originally built [**chat.langchain.com**](https://chat.langchain.com/) as a prototype, explicitly designed to serve two functions:
...
- **Step 1:** Search our docs ([docs.langchain.com](../home.md)) to understand what the feature is supposed to do.
- **Step 2:** Check our knowledge base ([support.langchain.com](https://support.langchain.com/)) to see if other users hit the same issue and how it was resolved.
...
We chose [`createAgent`](../javascript/releases/langchain-v1.md#createagent) (Agent abstraction in [`langchain`](../javascript/langchain/overview.md)) for [chat.langchain.com](https://chat.langchain.com/?ref=blog.langchain.com) as the default mode because it's best for **speed**.
...
Even elegant agent designs need production infrastructure to survive contact with real users. We built modular [middleware](../javascript/langchain/middleware.md#middleware) to handle the operational concerns that would otherwise clutter our prompts.
