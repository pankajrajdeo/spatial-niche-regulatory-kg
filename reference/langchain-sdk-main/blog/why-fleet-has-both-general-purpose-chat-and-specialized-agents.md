---
title: "Why Fleet Has Both General Purpose Chat and Specialized Agents"
description: "Fleet supports both quick, ad hoc tasks and recurring responsibilities. See how General Purpose Chat and Specialized Agents help teams delegate work."
...
tags: [blog, why-fleet-has-both-general-purpose-chat-and-specialized-agents]
---
...
To get started, you can [try Fleet free](https://smith.langchain.com/agents?skipOnboarding=true). To dive into more of the technical details, [read the docs](../langsmith/fleet.md).
