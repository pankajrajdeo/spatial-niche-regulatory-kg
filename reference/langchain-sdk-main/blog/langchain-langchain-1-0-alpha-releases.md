...
description: "LangChain &amp; LangGraph 1.0 alpha releases. Build production-ready AI agents with durable execution, standardized abstractions, and no vendor lock-in."
source: "https://www.langchain.com/blog/langchain-langchain-1-0-alpha-releases"
category: "blog"
published: "2025-09-02T17:02:02.000Z"
author: "LangChain Accounts"
tags: [blog, langchain-langchain-1-0-alpha-releases]
---
...
[`langgraph`](../langgraph/overview.md) has been battle tested as companies like [Uber](https://www.youtube.com/watch?v=8rkA5vWUE4Y&ref=blog.langchain.com), [LinkedIn](https://www.linkedin.com/blog/engineering/ai/practical-text-to-sql-for-data-analytics?ref=blog.langchain.com), and [Klarna](https://blog.langchain.com/customers-klarna/) use it in production. We are promoting it to 1.0 with no breaking changes. It comes with a built in agent runtime ([durable execution](../langgraph/durable-execution.md), [short term memory](../langgraph/persistence.md), [human in the loop patterns](../langchain/human-in-the-loop.md), streaming), and be used to build [arbitrary workflows](../langgraph/use-graph-api.md) and agentic patterns.

## LangChain

[`langchain`](../javascript/langchain/overview.md) has always contained high level interfaces for getting started with different agent patterns as easily as possible. Early on, there were a handful of these patterns (these made up all the chains and agents originally in `langchain`). Over the past two years, we have realized that:
