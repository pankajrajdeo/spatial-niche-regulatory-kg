...
description: "Build better Q&amp;A systems for CSV data using LangChain agents, retrieval, and LLM evaluation. Includes benchmarks, debugging insights, and open-source code."
source: "https://www.langchain.com/blog/benchmarking-question-answering-over-csv-data"
category: "blog"
published: "2023-08-15T05:16:00.000Z"
author: "LangChain Accounts"
tags: [blog, benchmarking-question-answering-over-csv-data]
---
...
In order to do this we needed to load a CSV into a vectorstore. We did this using the logic of our [CSVLoader](https://reference.langchain.com/python/langchain-community/document_loaders/csv_loader). What this does under the hood is:
