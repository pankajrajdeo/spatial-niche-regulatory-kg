...
description: "Learn proven strategies to speed up your AI agent: reduce latency, optimize LLM calls, enable parallelism, and improve UX. Expert tips from LangChain."
source: "https://www.langchain.com/blog/how-do-i-speed-up-my-agent"
category: "blog"
published: "2025-03-15T18:34:47.000Z"
author: "LangChain Accounts"
tags: [blog, how-do-i-speed-up-my-agent]
---
...
That is when we see people reach for [LangGraph](https://www.langchain.com/langgraph). LangGraph is low level, and allows you to specify exactly how these agents should communicate with each other (or when something is just an LLM call). Often times this leads to significantly less LLM calls, making the agent faster and cheaper (and often more reliable).
