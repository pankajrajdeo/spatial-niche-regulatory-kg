...
description: "Debug deep agents with LangSmith&#39;s tracing and analysis. Analyze complex traces, optimize prompts with Polly, and improve performance."
source: "https://www.langchain.com/blog/debugging-deep-agents-with-langsmith"
category: "blog"
published: "2025-12-10T17:08:19.000Z"
author: "LangChain Accounts"
tags: [blog, debugging-deep-agents-with-langsmith]
---

# Debugging Deep Agents with LangSmith

Debugging is the process of finding and fixing errors. This is a critical step in software engineering, and even more critical in [agent engineering](https://blog.langchain.com/agent-engineering-a-new-discipline/). One of the key capabilities of [LangSmith](../langsmith/home.md) is tooling to debug LLM applications.
...
Polly is a [new in-app feature](https://www.langchain.com/blog/introducing-polly-your-ai-agent-engineer) that allows you to chat with an agent to analyze your thread and trace data. See our [video overview here](https://youtu.be/4Ox2gdZnM6c?ref=blog.langchain.com).
