---
title: "aindex"
description: "Async index data from the loader into the vector store."
source: "https://reference.langchain.com/python/langchain-core/indexing/api/aindex"
category: "reference"
tags: [reference, langchain-core, indexing, api, aindex]
---
...
📖 [View in docs](https://reference.langchain.com/python/langchain-core/indexing/api/aindex)
...
|------|------|----------|-------------|
| `docs_source` | `BaseLoader \| Iterable[Document] \| AsyncIterator[Document]` | Yes | Data loader or iterable of documents to index. |
...
[View source on GitHub](https://github.com/langchain-ai/langchain/blob/348c9dc572599947d2d7d33d6a5b8b936e92a1d4/libs/core/langchain_core/indexing/api.py#L635)
