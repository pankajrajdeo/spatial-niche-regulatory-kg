...
description: "Run on new output token."
source: "https://reference.langchain.com/python/langchain-core/callbacks/base/LLMManagerMixin/on_llm_new_token"
category: "reference"
tags: [reference, langchain-core, callbacks, base, llmmanagermixin, on_llm_new_token]
---
...
📖 [View in docs](https://reference.langchain.com/python/langchain-core/callbacks/base/LLMManagerMixin/on_llm_new_token)
...
[View source on GitHub](https://github.com/langchain-ai/langchain/blob/348c9dc572599947d2d7d33d6a5b8b936e92a1d4/libs/core/langchain_core/callbacks/base.py#L65)
