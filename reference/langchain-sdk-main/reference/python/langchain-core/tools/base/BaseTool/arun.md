---
title: "arun"
description: "Run the tool asynchronously."
source: "https://reference.langchain.com/python/langchain-core/tools/base/BaseTool/arun"
category: "reference"
tags: [reference, langchain-core, tools, base, basetool, arun]
---
...
📖 [View in docs](https://reference.langchain.com/python/langchain-core/tools/base/BaseTool/arun)
...
| `**kwargs` | `Any` | No | Keyword arguments to be passed to tool callbacks (default: `{}`) |
...
[View source on GitHub](https://github.com/langchain-ai/langchain/blob/348c9dc572599947d2d7d33d6a5b8b936e92a1d4/libs/core/langchain_core/tools/base.py#L1137)
