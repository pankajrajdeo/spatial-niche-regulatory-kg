...
source: "https://reference.langchain.com/python/langchain/models"
category: "reference"
tags: [reference, langchain, models]
---
...
!!! note "Reference docs"
    ...
    This page contains **reference documentation** for chat models. See [the docs](../../../langchain/models.md) for conceptual guides, tutorials, and examples on using chat models.
