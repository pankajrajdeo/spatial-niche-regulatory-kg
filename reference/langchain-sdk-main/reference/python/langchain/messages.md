...
category: "reference"
tags: [reference, langchain, messages]
---
...
!!! note "Reference docs"
    ...
    This page contains **reference documentation** for Messages. See [the docs](../../../langchain/messages.md) for conceptual guides, tutorials, and examples on using Messages.
