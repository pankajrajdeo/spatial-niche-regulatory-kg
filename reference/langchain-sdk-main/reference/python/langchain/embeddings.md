...
category: "reference"
tags: [reference, langchain, embeddings]
---
...
!!! note "Reference docs"
    ...
    This page contains **reference documentation** for Embeddings. See [the docs](../../../langchain/retrieval.md#embedding-models) for conceptual guides, tutorials, and examples on using Embeddings.
