...
category: "docs"
tags: [docs, langsmith, agent-server-api, thread-runs, create-background-run]
---
    ...
    Run:
      properties:
        ...
        langsmith_session_name:
          ...
          description: >-
            LangSmith tracing session (project) name for this run, when tracing
            is enabled at creation time.
          nullable: true
      type: object
      required:
        - run_id
