...
source: "https://docs.langchain.com/langsmith/javascript/managed-deep-agents-evals"
category: "docs"
tags: [docs, langsmith, javascript, managed-deep-agents-evals]
---
...
> [!TIP]
> To use [Deep Agents Code](../../deepagents/code/overview.md) (`dcode`), install it with:
>
> ```bash
> curl -LsSf https://langch.in/dcode | bash
> ```
>
> See the [Deep Agents Code quickstart](../../deepagents/code/quickstart.md) for provider setup and interactive use.
...
> **Prompt:** Develop Harbor evals with the eval-engineering skill
...
* [CLI reference](managed-deep-agents-cli.md): review `mda evals init` and related flags.
* [Deploy an agent](managed-deep-agents-deploy.md): deploy the agent after its evals pass.
* [Deep Agents Code quickstart](../../deepagents/code/quickstart.md): install and run `dcode`.
* [Harbor integrations](../harbor-integrations.md): record Harbor jobs in LangSmith.
