...
> [!NOTE]
> Engine is available for LangSmith Self-hosted in **AWS US** and **GCP US**. See [Availability by cloud and region](engine-self-hosted.md#availability-by-cloud-and-region).
