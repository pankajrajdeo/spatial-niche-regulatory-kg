...
Minting a link requires the `sandboxes:exec` permission, the same access a credentialed download needs. See [Sandbox permissions](sandbox-permissions.md).
...
|                             | Download links         | `read()`              | [Service URLs](sandbox-service-urls.md) |
| --------------------------- | ---------------------- | --------------------- | ----------------------------------------------- |
...
| Error                                      | Cause                                                             | Fix                                                                                                                           |
| ------------------------------------------ | ----------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------- |
| **`501` on mint**                          | Download links are not configured for this deployment             | Self-hosted deployments need a sandbox service domain configured; see [Sandbox service URLs](sandbox-service-urls.md) |
