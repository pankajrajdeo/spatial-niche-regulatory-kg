...
Create and deploy your first Managed Deep Agent: scaffold a project, configure the model and instructions, add search, test in [LangSmith Studio](../studio.md), and deploy with the [`mda` CLI](managed-deep-agents-cli.md). Managed Deep Agents supplies the [Deep Agents harness](../../deepagents/overview.md) and hosted runtime.
...
When you deploy, Managed Deep Agents syncs these instructions to [LangSmith Context Hub](managed-deep-agents-context-hub.md), where you can update them without redeploying the agent.
...
#### [Connections](managed-deep-agents-connections.md)
