...
* `run: Run`: The full [Run](run-data-format.md) object generated by the application on the given example.
...
* [Evaluate aggregate experiment results](summary.md): Define summary evaluators, which compute metrics for an entire experiment.
* [Run an evaluation comparing two experiments](evaluate-pairwise.md): Define pairwise evaluators, which compute metrics by comparing two (or more) experiments against each other.
