...
An AWS proxy role lets LangSmith assume a customer IAM role and sign supported AWS HTTPS requests with renewable temporary credentials. It works with or without [S3 mounts](sandbox-mounts.md#authenticate-with-an-iam-role), without exposing real credentials to sandbox code.
