...
description: "This guide shows you how to send conversations automatically from the Claude Code CLI to LangSmith."
source: "https://docs.langchain.com/langsmith/trace-claude-code"
category: "docs"
tags: [docs, langsmith, trace-claude-code]
---
