...
#### [Build from a template](fleet/quickstart.md)
...
* [Essentials: connections, automation, memory, approvals](fleet/essentials.md)
* [Create from a template](fleet/templates.md)
* [Set up your workspace](fleet/workspace-admin.md)
* [Connect apps and services](fleet/tools.md) and [use remote connections](fleet/mcp-framework.md)
* [Choose between workspace and private agents](fleet/manage-agent-settings.md)
* [Authorize accounts when prompted](fleet/auth-format.md)
* [Call agents from your app](fleet/code.md)
