...
Behind the scenes, feedback configuration is added as [structured output](../langchain/structured-output.md) to the LLM-as-a-judge prompt. Each top-level key in the output schema will be treated as a separate piece of feedback.
