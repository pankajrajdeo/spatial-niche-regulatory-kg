...
description: "This endpoint allows clients to upload examples to a specified dataset by sending a multipart/form-data POST request. Each form part contains either JSON-encoded data or binary attachment files..."
source: "https://docs.langchain.com/langsmith/smith-api/examples/upload-examples"
category: "docs"
tags: [docs, langsmith, smith-api, examples, upload-examples]
---
...
tags:
  ...
  - name: productfeedback
    x-hidden: true
paths:
  /api/v1/platform/datasets/{dataset_id}/examples:
    post:
      tags:
        - examples
