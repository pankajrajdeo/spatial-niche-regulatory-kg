...
description: "/langsmith/langsmith-platform-openapi.json get /api/v1/workspaces/current/usage_limits"
source: "https://docs.langchain.com/langsmith/smith-api/workspaces/get-current-workspace-usage-limits-info"
category: "docs"
tags: [docs, langsmith, smith-api, workspaces, get-current-workspace-usage-limits-info]
---
...
paths:
  /api/v1/workspaces/current/usage_limits:
    get:
      ...
      operationId: >-
        get_current_workspace_usage_limits_info_api_v1_workspaces_current_usage_limits_get
      responses:
        '200':
