...
paths:
  /api/v1/workspaces/current/members/{identity_id}/pending:
    patch:
      tags:
        - workspaces
      summary: Patch current workspace pending member
      description: Update the role on a pending workspace member invite.
      operationId: >-
        patch_current_workspace_pending_member_api_v1_workspaces_current_members__identity_id__pending_patch
      parameters:
        - name: identity_id
          in: path
          required: true
      ...
      requestBody:
        ...
        content:
          application/json:
            schema:
              $ref: '#/components/schemas/PendingIdentityPatch'
      responses:
        '200':
