...
paths:
  /api/v1/workspaces/current/members/pending:
    get:
      ...
      operationId: >-
        get_current_pending_workspace_members_api_v1_workspaces_current_members_pending_get
      parameters:
        - name: limit
          in: query
          required: false
          ...
          content:
            application/json:
              schema:
                ...
                title: >-
                  Response Get Current Pending Workspace Members Api V1
                  Workspaces Current Members Pending Get
        '422':
