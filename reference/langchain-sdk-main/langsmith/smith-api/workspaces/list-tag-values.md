...
paths:
  /api/v1/workspaces/current/tag-keys/{tag_key_id}/tag-values:
    get:
      ...
      operationId: >-
        list_tag_values_api_v1_workspaces_current_tag_keys__tag_key_id__tag_values_get
      parameters:
        - name: tag_key_id
          in: path
          required: true
          ...
          content:
            application/json:
              schema:
                ...
                title: >-
                  Response List Tag Values Api V1 Workspaces Current Tag Keys 
                  Tag Key Id  Tag Values Get
        '422':
