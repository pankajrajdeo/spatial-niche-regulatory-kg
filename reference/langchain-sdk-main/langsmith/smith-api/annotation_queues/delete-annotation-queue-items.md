...
tags:
  ...
  - name: productfeedback
    x-hidden: true
paths:
  /api/v1/platform/annotation-queues/{queue_id}/items/delete:
    post:
      tags:
        - annotation_queues
      summary: Delete annotation queue items
      description: Remove RUN or THREAD items from a single annotation queue by item ID.
      parameters:
      ...
      requestBody:
        ...
        content:
          application/json:
            schema:
              $ref: >-
                #/components/schemas/annotationqueues.DeleteAnnotationQueueItemsRequest
      responses:
        '200':
          description: OK
          content:
...
components:
  schemas:
    annotationqueues.DeleteAnnotationQueueItemsRequest:
      type: object
      properties:
        item_ids:
          items:
