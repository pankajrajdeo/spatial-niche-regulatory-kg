...
category: "docs"
tags: [docs, langsmith, smith-api, annotation_queues, remove-a-reviewer-from-an-annotation-queue]
---
...
tags:
  ...
  - name: productfeedback
    x-hidden: true
paths:
  /api/v1/platform/annotation-queues/{queue_id}/reviewers/{identity_id}:
    delete:
      tags:
        - annotation_queues
