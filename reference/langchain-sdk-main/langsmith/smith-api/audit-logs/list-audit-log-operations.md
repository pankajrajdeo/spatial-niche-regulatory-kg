...
tags:
  ...
  - name: productfeedback
    x-hidden: true
paths:
  /api/v1/audit-logs/operations:
    get:
      tags:
        - audit-logs
      summary: List audit log operations
      description: >-
        List all possible audit log operation names, for populating filter UI.

        Independent of any operations actually recorded so far for the
        organization.
      operationId: list_audit_log_operations_api_v1_audit_logs_operations_get
      responses:
        '200':
          ...
          content:
            application/json:
              schema:
                $ref: '#/components/schemas/ListAuditLogOperationsResponse'
      security:
        - API Key: []
        - Organization ID: []
        - Bearer Auth: []
components:
  schemas:
    ListAuditLogOperationsResponse:
      ...
      required:
        - operations
      title: ListAuditLogOperationsResponse
  securitySchemes:
    API Key:
      type: apiKey
      in: header
