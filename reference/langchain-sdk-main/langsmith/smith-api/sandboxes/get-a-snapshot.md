...
description: "Get a sandbox snapshot by ID or by a Docker-style reference. A bare name means name:latest, falling back to the newest ready untagged snapshot of that name. To list the tags under a name, use..."
source: "https://docs.langchain.com/langsmith/smith-api/sandboxes/get-a-snapshot"
category: "docs"
tags: [docs, langsmith, smith-api, sandboxes, get-a-snapshot]
---
...
tags:
  ...
  - name: productfeedback
    x-hidden: true
paths:
  /api/v2/sandboxes/snapshots/{snapshot_id}:
    get:
      tags:
        - sandboxes
      summary: Get a snapshot
      description: >-
        Get a sandbox snapshot by ID or by a Docker-style reference. A bare name
        means name:latest, falling back to the newest ready untagged snapshot of
        that name. To list the tags under a name, use
        /api/v2/sandboxes/snapshots-by-name/{name}.
      parameters:
        - description: Snapshot UUID, a name:tag reference, or a bare snapshot name
          name: snapshot_id
          in: path
          required: true
          schema:
