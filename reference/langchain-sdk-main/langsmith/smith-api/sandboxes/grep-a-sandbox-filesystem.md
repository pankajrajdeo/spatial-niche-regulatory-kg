...
tags:
  ...
  - name: productfeedback
    x-hidden: true
paths:
  /api/v2/sandboxes/{sandbox_id}/grep:
    post:
      tags:
        - sandboxes
      summary: Grep a sandbox filesystem
      description: Search files under a root path for a literal text pattern (not a regex).
      parameters:
      ...
      requestBody:
        ...
        content:
          application/json:
            schema:
              $ref: '#/components/schemas/sandboxes.GrepRequest'
      responses:
        '200':
          description: OK
          content:
    ...
    sandboxes.GrepResponse:
      ...
      properties:
        matches:
          type: array
          items:
            $ref: '#/components/schemas/sandboxapi.GrepMatch'
        truncated:
          type: boolean
