...
tags:
  ...
  - name: productfeedback
    x-hidden: true
paths:
  /api/v2/sandboxes/{sandbox_id}/glob:
    post:
      tags:
        - sandboxes
      summary: Glob a sandbox filesystem
      description: >-
        Find files under a root path matching a glob pattern (supports **).
        Entries are returned in lexical order by path.
      parameters:
      ...
      requestBody:
        ...
        content:
          application/json:
            schema:
              $ref: '#/components/schemas/sandboxes.GlobRequest'
      responses:
        '200':
          description: OK
          content:
            application/json:
              schema:
                $ref: '#/components/schemas/sandboxes.GlobResponse'
        '400':
  ...
  schemas:
    sandboxes.GlobRequest:
      ...
      properties:
        ...
        pattern:
          type: string
    sandboxes.GlobResponse:
      type: object
      properties:
        matches:
          type: array
          items:
            $ref: '#/components/schemas/sandboxapi.FileInfo'
        truncated:
          type: boolean
