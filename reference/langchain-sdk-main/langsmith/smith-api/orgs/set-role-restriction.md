...
tags:
  ...
  - name: productfeedback
    x-hidden: true
paths:
  /api/v1/orgs/current/roles/{role_id}/restriction:
    put:
      tags:
        - orgs
      summary: Set role restriction
      operationId: set_role_restriction_api_v1_orgs_current_roles__role_id__restriction_put
      parameters:
        - name: role_id
          in: path
          required: true
      ...
      requestBody:
        ...
        content:
          application/json:
            schema:
              $ref: '#/components/schemas/RoleRestrictionUpdate'
      responses:
        '200':
