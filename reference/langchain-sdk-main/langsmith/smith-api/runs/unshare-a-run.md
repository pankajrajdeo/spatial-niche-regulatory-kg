...
tags:
  ...
  - name: productfeedback
    x-hidden: true
paths:
  /api/v2/runs/{trace_id}/share:
    delete:
      tags:
        - runs
      summary: Unshare a run
      description: >-
        Deletes the share token for the trace identified by trace_id and
        session_id. Idempotent: returns 204 whether or not a share token
        existed.
      ...
      requestBody:
        ...
        content:
          application/json:
            schema:
              $ref: '#/components/schemas/share.DeleteShareTokenRequestBody'
      responses:
        '204':
...
components:
  schemas:
    share.DeleteShareTokenRequestBody:
      type: object
      properties:
        session_id:
