...
tags:
  ...
  - name: productfeedback
    x-hidden: true
paths:
  /api/v2/runs/{run_id}/share:
    post:
      tags:
        - runs
      summary: Share a run
      description: >-
        Creates or returns a share token for a run. Child runs share their trace
        root.
      ...
      requestBody:
        ...
        content:
          application/json:
            schema:
              $ref: '#/components/schemas/share.CreateShareTokenRequestBody'
      responses:
        '200':
          description: OK
          content:
            application/json:
              schema:
                $ref: '#/components/schemas/share.CreateShareTokenResponseBody'
        '400':
...
components:
  schemas:
    share.CreateShareTokenRequestBody:
      type: object
      properties:
        session_id:
          description: session_id is the tracing project UUID containing the trace.
          type: string
          format: uuid
          example: 018e4c7e-a9fb-7ef0-a5b6-6ea3a82e9327
        trace_id:
          description: trace_id is the root trace UUID to share.
          type: string
          format: uuid
          example: 018e4c7e-a9fb-7ef0-a5b6-6ea3a82e9327
