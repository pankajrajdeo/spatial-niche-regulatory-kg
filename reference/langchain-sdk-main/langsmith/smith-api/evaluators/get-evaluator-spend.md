  ...
  /api/v1/platform/evaluators/spend:
    get:
      ...
      description: >-
        ...
        feedback_key, and tag_value_id may be supplied with group_by to narrow
      ...
      parameters:
        ...
        - description: >-
          ...
          schema:
            ...
            title: Feedback Key
        - description: >-
            Filter grouped results to evaluators, projects, or datasets tagged
            with all supplied tag value IDs. Only valid with group_by.
          name: tag_value_id
          in: query
          style: form
          explode: false
