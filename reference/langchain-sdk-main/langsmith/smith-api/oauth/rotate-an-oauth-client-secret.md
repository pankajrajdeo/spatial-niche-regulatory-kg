...
tags:
  ...
  - name: productfeedback
    x-hidden: true
paths:
  /api/v1/platform/oauth/clients/{id}/rotate-secret:
    post:
      tags:
        - oauth
      summary: Rotate an oauth client secret
      description: >-
        Generates a new client secret for a confidential client, invalidating
        the previous one. The new secret is shown only once.
      parameters:
