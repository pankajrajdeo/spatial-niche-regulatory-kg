...
paths:
  /userinfo:
    get:
      ...
      description: >-
        Returns identity claims for the user represented by a LangSmith access
        token whose audience is the identity resource or the API resource. The
        token is passed as a Bearer credential in the Authorization header
      ...
      responses:
        '200':
          ...
          content:
            application/json:
              schema:
                $ref: '#/components/schemas/oauth.UserinfoResponse'
        '401':
