...
tags:
  ...
  - name: productfeedback
    x-hidden: true
paths:
  /api/v1/platform/oauth/authorized-apps/{clientID}:
    delete:
      tags:
        - oauth
      summary: Revoke an authorized application
      description: >-
        Revokes the authenticated user's authorization for an application and
        invalidates that application's active tokens for the user.
      parameters:
