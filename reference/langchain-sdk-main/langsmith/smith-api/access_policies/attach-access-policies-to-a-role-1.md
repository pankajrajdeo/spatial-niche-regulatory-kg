...
source: "https://docs.langchain.com/langsmith/smith-api/access_policies/attach-access-policies-to-a-role-1"
category: "docs"
tags: [docs, langsmith, smith-api, access_policies, attach-access-policies-to-a-role-1]
---
...
**/langsmith/langsmith-platform-openapi.json post /api/v1/platform/orgs/current/roles/{role_id}/access-policies**
          ...
          content:
            application/json:
              schema:
                $ref: '#/components/schemas/shared.ProblemDetails'
        '404':
          description: Role or access policy not found
          content:
            application/json:
              schema:
                $ref: '#/components/schemas/shared.ProblemDetails'
