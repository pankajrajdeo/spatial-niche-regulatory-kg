  ...
  schemas:
    features.FeatureConfig:
      ...
      properties:
        ...
        disabled_models:
          description: >-
            DisabledModels is the effective disabled set for the feature: the
            union of

            this workspace's own disabled providers/models and the org-wide
            disabled
        ...
        feature:
          type: string
        org_disabled_providers:
          description: >-
            OrgDisabledProviders is the subset of DisabledModels that is
            enforced at the

            organization level. The workspace settings UI renders these locked
            so a
