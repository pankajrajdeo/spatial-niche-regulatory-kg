---
title: "Save the agent overview for a session (Beta)"
description: "Beta: This endpoint is in active development and may change without notice."
source: "https://docs.langchain.com/langsmith/smith-api/issues-agent/save-the-agent-overview-for-a-session-beta"
category: "docs"
tags: [docs, langsmith, smith-api, issues-agent, save-the-agent-overview-for-a-session-beta]
---
...
tags:
  ...
  - name: productfeedback
    x-hidden: true
paths:
  /api/v1/platform/sessions/{session_id}/issues-agent/overview:
    patch:
      tags:
        - issues-agent
      summary: Save the agent overview for a session (Beta)
      description: >-
        **Beta:** This endpoint is in active development and may change without
        notice.

        Saves the issues agent overview content server-side, creating or
        updating
