---
title: "Get one run in a public shared thread"
description: "Returns a single run, including full inputs and outputs, provided its trace root belongs to the shared thread."
source: "https://docs.langchain.com/langsmith/smith-api/threads/get-one-run-in-a-public-shared-thread"
category: "docs"
tags: [docs, langsmith, smith-api, threads, get-one-run-in-a-public-shared-thread]
---
...
paths:
  /api/v2/public/threads/{share_token}/runs/{run_id}:
    get:
      tags:
        - threads
      summary: Get one run in a public shared thread
      description: >-
        Returns a single run, including full inputs and outputs, provided its
        trace root belongs to the shared thread.
      ...
      parameters:
        ...
        - description: Run UUID
          ...
          schema:
            type: string
            format: uuid
        - description: Run start_time coordinate (RFC3339)
          name: start_time
          in: query
          required: true
          schema:
      ...
      responses:
        ...
        '404':
          description: share token, run, or shared thread not found
          content:
            application/json:
              schema:
                $ref: '#/components/schemas/shared.ProblemDetails'
