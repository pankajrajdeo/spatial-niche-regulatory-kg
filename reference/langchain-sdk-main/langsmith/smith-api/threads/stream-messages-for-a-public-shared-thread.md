...
tags:
  ...
  - name: productfeedback
    x-hidden: true
paths:
  /api/v2/public/threads/{share_token}/messages:
    get:
      tags:
        - threads
      summary: Stream messages for a public shared thread
      description: |-
        Streams the thread's conversation as server-sent events. SSE only.
      ...
      parameters:
        ...
        - description: Share token UUID
          ...
          schema:
            type: string
            format: uuid
        - description: messages page size
          name: page_size
          in: query
          schema:
            type: integer
        ...
        - description: opaque cursor from a previous page
          ...
          schema:
            type: string
            title: Cursor
        - description: anchor the page on this trace
          name: trace_id
          in: query
          schema:
            type: string
