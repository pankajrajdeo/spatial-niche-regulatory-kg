...
tags:
  ...
  - name: productfeedback
    x-hidden: true
paths:
  /api/v2/public/threads/{share_token}:
    get:
      tags:
        - threads
      summary: Get a public shared thread's manifest
      description: >-
        Returns the thread and project a share token is scoped to, plus the
        project's conversations config.
      ...
      responses:
        '200':
          ...
          content:
            application/json:
              schema:
                $ref: '#/components/schemas/threadshare.ThreadManifest'
        '404':
