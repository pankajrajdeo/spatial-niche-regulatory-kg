...
tags:
  ...
  - name: productfeedback
    x-hidden: true
paths:
  /api/v1/platform/gateway-policies/search:
    post:
      tags:
        - gateway-policies
      summary: Search gateway policies by subject value set
      description: |-
        Batch variant of GET /v1/platform/gateway-policies for
        fetching policies that match a set of subject_matcher_values
        under one subject_matcher_key. Accepts the values in a JSON
      ...
      requestBody:
        ...
        content:
          application/json:
            schema:
              $ref: >-
                #/components/schemas/gateway_policies.SearchGatewayPoliciesRequest
      responses:
        '200':
          description: OK
          content:
