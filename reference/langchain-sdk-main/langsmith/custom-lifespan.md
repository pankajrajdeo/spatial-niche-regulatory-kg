...
This works the same way as [adding custom routes](custom-routes.md). You just need to provide your own [`Starlette`](https://starlette.dev/applications/) app (including [`FastAPI`](https://fastapi.tiangolo.com/), [`FastHTML`](https://fastht.ml/) and other compatible apps).
