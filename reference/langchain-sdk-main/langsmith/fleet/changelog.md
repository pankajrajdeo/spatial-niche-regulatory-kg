...
* Fleet access profiles now show Custom rule, AWS access, and GCP access options alongside service templates, including configurable GCP OAuth scopes, so you can configure computer credentials without leaving the setup flow. [Learn more](computer-use.md).
